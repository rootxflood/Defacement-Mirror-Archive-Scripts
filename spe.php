...
if ($ip = $dat['serip']) {
			...
			$cekSpecial = '<i class="fa fa-star-o">';
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center"><a href="attacker_<?php echo $dat['hacker']; ?>-1.html"><?php echo htmlspecialchars($dat['hacker']); ?></a></td>
                            <td><a href="<?php echo $dat['url']; ?>"><?php echo $url; ?></a></td>
                            <td class="text-center"><?php echo $cekHome; ?></td>
                            <td><center><img src='flags/<?php echo $cc; ?>.png' alt='<?php echo $cn; ?>' title='<?php echo $cn; ?>'></center></td><td class="text-center"><?php echo $dat['serip']; ?></a></td>
            ...
            <div class="pull-right">
                <div class="dataTables_paginate paging_bootstrap">
                    <ul class="pagination pagination-sm">
                        ...
                        if ($noS > 1)
                            echo "<li class='prev'><a href='special-" . ($noS - 1) . ".html'> Prev</a></li>";
                        ...
                        for ($page = 1; $page <= $jumPage; $page++) {
                            if ((($page >= $noS - 3) && ($page <= $noS + 3)) || ($page == 1) || ($page == $jumPage)) {
                                ...
                                if ($page == $noPage)
                                    ...
                                    echo " <li><a href='special-" . $page . ".html'>" . $page . "</a></li> ";
                                $showPage = $page;
                            }
                        }
                        ...
                        if ($noS < $jumPage)
                            echo "<li class='next'><a href='special-" . ($noS + 1) . ".html'>Next </a></li>";
                        ?>
                    </ul>
                </div>
            </div>
